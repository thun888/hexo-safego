...
module.exports = function (locals) {
    ...
    const html = template.render({
        ...
        auto_redirect: safegoConfig.general.auto_redirect || false,
        ...
        theme_color: safegoConfig.appearance.theme_color || "#056DE8",
        siteinfo_api: safegoConfig.siteinfo.api || '',
        siteinfo_enable: safegoConfig.siteinfo.enable || false
    });
